...
for (jj in 1:20)
{
  ses <- ses.mpd(ta_sc[[jj]], wood.mat, null.model = "taxa.labels", runs = 9999)
  ses.a <- ses.mpd(ta_sc[[jj]], wood.mat, null.model = "taxa.labels", runs = 9999, abundance.weighted = T)
  ta_sc_ses[[jj]] <- cbind(z = ses$mpd.obs.z, p = ses$mpd.obs.p,
                           z.a = ses.a$mpd.obs.z, p.a = ses.a$mpd.obs.p)
  
  ses <- ses.mpd(sa_sc[[jj]], wood.mat, null.model = "taxa.labels", runs = 9999)
  ses.a <- ses.mpd(sa_sc[[jj]], wood.mat, null.model = "taxa.labels", runs = 9999, abundance.weighted = T)
  sa_sc_ses[[jj]] <- cbind(z = ses$mpd.obs.z, p = ses$mpd.obs.p,
                           z.a = ses.a$mpd.obs.z, p.a = ses.a$mpd.obs.p)
  
  ses <- ses.mpd(ha_sc[[jj]], herb.mat, null.model = "taxa.labels", runs = 9999)
  ses.a <- ses.mpd(ha_sc[[jj]], herb.mat, null.model = "taxa.labels", runs = 9999, abundance.weighted = T)
