...
wood.tree <- drop.tip(phylo, phylo$tip.label[-id])

# plot final tree
plot(wood.tree, cex = 0.7)
axisPhylo()

# save results
save(wood.tree, file = "clean.data/wood-phylo.rda")
save(ta, file = "clean.data/tree-abund.rda")
save(sa, file = "clean.data/shrub-abund.rda")