...
png("figures/tree-mpd1.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(t.ses ~ r, res, col = "tomato", pch = 19, xlab = "Размер видового пула", ylab = "MPD")
dev.off()
png("figures/shrub-mpd1.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(s.ses ~ r, res, col = "skyblue", pch = 16, xlab = "Размер видового пула", ylab = "MPD")
dev.off()
png("figures/herb-mpd1.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(h.ses ~ r, res, col = "forestgreen", pch = 16, xlab = "Размер видового пула", ylab = "MPD")
dev.off()

png("figures/tree-mpd2.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(1:rmax, tapply(res$t.ses, res$r, mean, na.rm = T), pch = 19, col = "tomato", xlab = "Размер видового пула", ylab = "Средний MPD")
dev.off()
png("figures/shrub-mpd2.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(1:rmax, tapply(res$s.ses, res$r, mean, na.rm = T), pch = 19, col = "skyblue", xlab = "Размер видового пула", ylab = "Средний MPD")
dev.off()
png("figures/herb-mpd2.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(1:rmax, tapply(res$h.ses, res$r, mean, na.rm = T), pch = 19, col = "forestgreen", xlab = "Размер видового пула", ylab = "Средний MPD")
dev.off()

png("figures/tree-mpd-a1.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(t.ses.a ~ r, res, col = "tomato", pch = 16, xlab = "Размер видового пула", ylab = "MPD")
dev.off()
png("figures/shrub-mpd-a1.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(s.ses.a ~ r, res, col = "skyblue", pch = 16, xlab = "Размер видового пула", ylab = "MPD")
dev.off()
png("figures/herb-mpd-a1.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(h.ses.a ~ r, res, col = "forestgreen", pch = 16, xlab = "Размер видового пула", ylab = "MPD")
dev.off()

png("figures/tree-mpd-a2.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(1:rmax, tapply(res$t.ses.a, res$r, mean, na.rm = T), pch = 19, col = "tomato", xlab = "Размер видового пула", ylab = "Средний MPD")
dev.off()
png("figures/shrub-mpd-a2.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(1:rmax, tapply(res$s.ses.a, res$r, mean, na.rm = T), pch = 19, col = "skyblue", xlab = "Размер видового пула", ylab = "Средний MPD")
dev.off()
png("figures/herb-mpd-a2.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
plot(1:rmax, tapply(res$h.ses.a, res$r, mean, na.rm = T), pch = 19, col = "forestgreen", xlab = "Размер видового пула", ylab = "Средний MPD")
dev.off()
...
png("figures/tree-reg-a.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
fit <- lme(fixed = -t.ses.a ~ r, random = ~ 1 | id, data = res, method = "REML", na.action = "na.omit")
ef <- effect("r", fit)
plot(-t.ses.a ~ r, res, col = "tomato", pch = 16, xlab = "Размер видового пула", ylab = "NRI")
lines(ef$x$r, ef$fit, type = "l", lwd = 3, ylim = range(ef$lower, ef$upper), pch = 16, xlab = "Размер видового пула", ylab = "MPD")
lines(ef$x$r, ef$lower)
lines(ef$x$r, ef$upper)
dev.off()

png("figures/shrub-reg-a.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
fit <- lme(fixed = -s.ses.a ~ r, random = ~ 1 | id, data = res, method = "REML", na.action = "na.omit")
ef <- effect("r", fit)
plot(-s.ses.a ~ r, res, col = "skyblue", pch = 16, xlab = "Размер видового пула", ylab = "NRI")
lines(ef$x$r, ef$fit, type = "l", lwd = 3, ylim = range(ef$lower, ef$upper), pch = 16, xlab = "Размер видового пула", ylab = "MPD")
lines(ef$x$r, ef$lower)
lines(ef$x$r, ef$upper)
dev.off()

png("figures/herb-reg-a.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
fit <- lme(fixed = -h.ses.a ~ r, random = ~ 1 | id, data = res, method = "REML", na.action = "na.omit")
ef <- effect("r", fit)
plot(-h.ses.a ~ r, res, col = "forestgreen", pch = 16, xlab = "Размер видового пула", ylab = "NRI")
lines(ef$x$r, ef$fit, type = "l", lwd = 3, ylim = range(ef$lower, ef$upper), pch = 16, xlab = "Размер видового пула", ylab = "MPD")
lines(ef$x$r, ef$lower)
lines(ef$x$r, ef$upper)
dev.off()

png("figures/tree-reg.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
fit <- lme(fixed = -t.ses ~ r, random = ~ 1 | id, data = res, method = "REML", na.action = "na.omit")
ef <- effect("r", fit)
plot(-t.ses ~ r, res, col = "tomato", pch = 16, xlab = "Размер видового пула", ylab = "NRI")
lines(ef$x$r, ef$fit, type = "l", lwd = 3, ylim = range(ef$lower, ef$upper), pch = 16, xlab = "Размер видового пула", ylab = "MPD")
lines(ef$x$r, ef$lower)
lines(ef$x$r, ef$upper)
dev.off()

png("figures/shrub-reg.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
fit <- lme(fixed = -s.ses ~ r, random = ~ 1 | id, data = res, method = "REML", na.action = "na.omit")
ef <- effect("r", fit)
plot(-s.ses ~ r, res, col = "skyblue", pch = 16, xlab = "Размер видового пула", ylab = "NRI")
lines(ef$x$r, ef$fit, type = "l", lwd = 3, ylim = range(ef$lower, ef$upper), pch = 16, xlab = "Размер видового пула", ylab = "MPD")
lines(ef$x$r, ef$lower)
lines(ef$x$r, ef$upper)
dev.off()

png("figures/herb-reg.png", width = 600, height = 400)
par(mar = c(4, 4, 0.5, 0.5), cex = 2)
fit <- lme(fixed = -h.ses ~ r, random = ~ 1 | id, data = res, method = "REML", na.action = "na.omit")
ef <- effect("r", fit)
plot(-h.ses ~ r, res, col = "forestgreen", pch = 16, xlab = "Размер видового пула", ylab = "NRI")
lines(ef$x$r, ef$fit, type = "l", lwd = 3, ylim = range(ef$lower, ef$upper), pch = 16, xlab = "Размер видового пула", ylab = "MPD")
lines(ef$x$r, ef$lower)
lines(ef$x$r, ef$upper)
dev.off()
