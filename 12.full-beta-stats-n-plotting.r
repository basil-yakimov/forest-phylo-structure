...
plot(tt0 ~ dh, data = beta, pch = 19, col = rgb(0.25, 0.75, 0.25, 0.3))
plot(tt1 ~ dh, data = beta, pch = 19, col = rgb(0.25, 0.75, 0.25, 0.3))
plot(tt2 ~ dh, data = beta, pch = 19, col = rgb(0.25, 0.75, 0.25, 0.3))

plot(st0 ~ dh, data = beta, pch = 19, col = rgb(0.25, 0.25, 0.75, 0.3))
plot(st1 ~ dh, data = beta, pch = 19, col = rgb(0.25, 0.25, 0.75, 0.3))
plot(st2 ~ dh, data = beta, pch = 19, col = rgb(0.25, 0.25, 0.75, 0.3))

plot(ht0 ~ dh, data = beta, pch = 19, col = rgb(0.75, 0.25, 0.25, 0.3))
plot(ht1 ~ dh, data = beta, pch = 19, col = rgb(0.75, 0.25, 0.25, 0.3))
plot(ht2 ~ dh, data = beta, pch = 19, col = rgb(0.75, 0.25, 0.25, 0.3))
