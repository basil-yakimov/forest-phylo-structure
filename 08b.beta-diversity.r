...
res0 <- tapply(1:96, subs, function(x) t.decomp(ta[x[1:8], ], 0), simplify = T)
res0 <- data.frame(t(simplify2array(res0)))

res1 <- tapply(1:96, subs, function(x) t.decomp(ta[x[1:8], ], 1), simplify = T)
res1 <- data.frame(t(simplify2array(res1)))

res2 <- tapply(1:96, subs, function(x) t.decomp(ta[x[1:8], ], 2), simplify = T)
...
res0 <- tapply(1:96, subs, function(x) p.decomp(ta[x[1:8], ], wood.tree, 0), simplify = T)
res0 <- data.frame(t(simplify2array(res0)))

res1 <- tapply(1:96, subs, function(x) p.decomp(ta[x[1:8], ], wood.tree, 1), simplify = T)
res1 <- data.frame(t(simplify2array(res1)))

res2 <- tapply(1:96, subs, function(x) p.decomp(ta[x[1:8], ], wood.tree, 2), simplify = T)
res2 <- data.frame(t(simplify2array(res2)))
...
res0 <- tapply(1:96, subs, function(x) t.decomp(sa[x[1:8], ], 0), simplify = T)
res0 <- data.frame(t(simplify2array(res0)))

res1 <- tapply(1:96, subs, function(x) t.decomp(sa[x[1:8], ], 1), simplify = T)
res1 <- data.frame(t(simplify2array(res1)))

res2 <- tapply(1:96, subs, function(x) t.decomp(sa[x[1:8], ], 2), simplify = T)
res2 <- data.frame(t(simplify2array(res2)))
...
res0 <- tapply(1:96, subs, function(x) p.decomp(sa[x[1:8], ], wood.tree, 0), simplify = T)
res0 <- data.frame(t(simplify2array(res0)))

res1 <- tapply(1:96, subs, function(x) p.decomp(sa[x[1:8], ], wood.tree, 1), simplify = T)
res1 <- data.frame(t(simplify2array(res1)))

res2 <- tapply(1:96, subs, function(x) p.decomp(sa[x[1:8], ], wood.tree, 2), simplify = T)
res2 <- data.frame(t(simplify2array(res2)))
...
res0 <- tapply(1:96, subs, function(x) t.decomp(ha[x[1:8], ], 0), simplify = T)
res0 <- data.frame(t(simplify2array(res0)))

res1 <- tapply(1:96, subs, function(x) t.decomp(ha[x[1:8], ], 1), simplify = T)
res1 <- data.frame(t(simplify2array(res1)))

res2 <- tapply(1:96, subs, function(x) t.decomp(ha[x[1:8], ], 2), simplify = T)
res2 <- data.frame(t(simplify2array(res2)))
...
res0 <- tapply(1:96, subs, function(x) p.decomp(ha[x[1:8], ], herb.tree, 0), simplify = T)
res0 <- data.frame(t(simplify2array(res0)))

res1 <- tapply(1:96, subs, function(x) p.decomp(ha[x[1:8], ], herb.tree, 1), simplify = T)
res1 <- data.frame(t(simplify2array(res1)))

res2 <- tapply(1:96, subs, function(x) p.decomp(ha[x[1:8], ], herb.tree, 2), simplify = T)
res2 <- data.frame(t(simplify2array(res2)))
...
plot.ses(hb$c0, mhgt, col = "tomato", lab = expression(C[0]))
plot.ses(hb$pc0, mhgt, col = "tomato", lab = expression(PC[0]))
...
plot.ses(hb$c1, mhgt, col = "tomato", lab = expression(C[1]))
plot.ses(hb$pc1, mhgt, col = "tomato", lab = expression(PC[1]))
...
plot.ses(hb$c2, mhgt, col = "tomato", lab = expression(C[2]))
plot.ses(hb$pc2, mhgt, col = "tomato", lab = expression(PC[2]))
par(op)
...
plot.ses(hb$u0, mhgt, col = "tomato", lab = expression(U[0]))
plot.ses(hb$pu0, mhgt, col = "tomato", lab = expression(PU[0]))
...
plot.ses(hb$u1, mhgt, col = "tomato", lab = expression(U[1]))
plot.ses(hb$pu1, mhgt, col = "tomato", lab = expression(PU[1]))
...
plot.ses(hb$u2, mhgt, col = "tomato", lab = expression(U[2]))
plot.ses(hb$pu2, mhgt, col = "tomato", lab = expression(PU[2]))
par(op)
