...
ha$Prenanthes_tatarinowii <- ha$Prenanthes_macrophylla + ha$Prenanthes_tatarinowii #один и тот же вид
ha$Prenanthes_macrophylla <- NULL

ha$Bupleurum_chinense <- ha$Bupleurum_chinense + ha$Bupleurum_chinense.1 #подвид первого
